...
mysql -uroot -h netapi_db -b networkapi -e "INSERT into equiptos_access (`id_equiptos_access`, `user`, `pass`, `id_equip`, `fqdn`, `id_tipo_acesso`) values (1, 'admin', 'admin',  10, 'http://${REMOTE_CTRL}:8181', 4);
